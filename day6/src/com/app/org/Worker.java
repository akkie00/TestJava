...
public class Worker extends Employee{
	 ...
	 * "Worker details: "+"id "+super.getId()+"name "+super.getName()+"DeptID "
	 * +super.getDeptID() +"Hrs worked: "+hoursWorked+"Hrly Rate: "+hourlyRate; }
	 */
	
	//overriding toString()
	@Override
	public String toString() {
		return "Worker Details: "+super.toString()+" "+hourlyRate+" "+hoursWorked;
	}
